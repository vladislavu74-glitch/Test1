...
// размещают вакансии у себя" без парсинга произвольного HTML. Применяется
// к HiringResource, у которого в scanConfig указаны provider + boardSlug
// (их видно в адресной строке карьерной страницы компании, например
// career.greenhouse.io/<slug> или jobs.lever.co/<company>).
